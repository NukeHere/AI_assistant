...
public class MainActivity extends Activity {
    ...
    private String decorateStructuredText(String author, String text) {
        ...
        for (String line : lines) {
            String cleaned = line
                    .replace("**Observation:**", author.equals("ALIEN") ? "[СИГНАЛ]" : "[НАБЛЮДЕНИЕ]")
                    .replace("**Diagnosis:**", author.equals("ALIEN") ? "[ДИССОНАНС]" : "[ДИАГНОСТИКА]")
                    .replace("**Diagnostic:**", author.equals("ALIEN") ? "[ДИССОНАНС]" : "[ДИАГНОСТИКА]")
                    .replace("**Recommended action:**", author.equals("ALIEN") ? "[НОТА ДЕЙСТВИЯ]" : "[ДЕЙСТВИЕ]")
                    .replace("**Command action:**", author.equals("ALIEN") ? "[КОМАНДНАЯ НОТА]" : "[КОМАНДА]")
                    .replace("**Explanation:**", author.equals("ALIEN") ? "[ГЛУБИНА]" : "[ОБЪЯСНЕНИЕ]")
                    .replace("**Conclusion:**", author.equals("ALIEN") ? "[РЕЗОНАНС]" : "[ВЫВОД]");
