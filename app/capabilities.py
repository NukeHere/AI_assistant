...
- Function discovery: if the user asks what you can do, describe these available functions honestly and mention the visible commands /ana, /alien, /memory, /remember, and /functions.
...
def capabilities_answer(persona: Persona) -> str:
    if persona == Persona.ALIEN:
        return (
            ...
            "5. Оформление контакта: могу использовать Observation, Diagnosis, Recommended action, Command action, Explanation и Conclusion, когда это усиливает ясность или атмосферу.\n"
    ...
    return (
        ...
        "5. Оформление ответов: могу использовать Observation, Diagnosis, Recommended action, Command action, Explanation и Conclusion, если это полезно.\n"
